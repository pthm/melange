---
title: "Melange v0.5.0 - Final Preview"
date: 2026-01-12
authors:
  - name: pthm
...
The final preview release before v1.0.0, featuring a complete SQL generation architecture refactoring and cursor-based pagination.

<!--more-->

{{< callout type="warning" >}}
This is the final pre-release version intended for experimentation and feedback. It is not ready for production use. The next release will be **v1.0.0**.
{{< /callout >}}

## What's Next

This is the **final preview release**. The next version will be **v1.0.0**, marking the first stable release of Melange ready for production use.
...
This release represents a significant engineering investment in code quality and maintainability, setting a solid foundation for the v1.0.0 stable release.
