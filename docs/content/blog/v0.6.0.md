...
{{< callout type="info" >}}
This is the first release suitable for building new projects. While still pre-1.0 and not recommended for deploying into existing live systems, v0.6.0 represents a significant maturity milestone and is ready for experimentation and feedback.
{{< /callout >}}
...
This release focuses on performance optimization and production readiness. After five preview releases refining the architecture, v0.6.0 delivers significant performance improvements and the tooling needed for real applications.
...
| Operation Category     | v0.5.1 (ms) | v0.6.0 (ms) | Improvement |
| ---------------------- | ----------- | ----------- | ----------- |
...
**v0.6.0 - Performance & Production Readiness**
...
Get started with Melange v0.6.0:
...
# For Go projects
go get github.com/pthm/melange/melange@v0.6.0
