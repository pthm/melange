module github.com/pthm/melange/test
...
require (
	...
	github.com/pthm/melange v0.9.2
...
// This module is never published; it depends on the root module and runtime
// as they exist in-tree, not on their published tags (which still contain the
// old in-root test/ subtree). Matches connect-go internal/conformance and
// atlas cmd/atlas. go.work wires the same redirect for multi-module dev.
replace (
